...
import blogImg1 from '../../image/leon.jpg';
import blogImg2 from '../../image/nubleson.jpg';
import blogImg3 from '../../image/photo.jpg';
        ...
        <div className="blogs__list">
          <div className="blog-card blog-card--row">
            <div className="blog-card__image-container">
              <img src={blogImg1} alt="Blog 1" className="blog-card__image" />
            </div>
          ...
          <div className="blog-card blog-card--row">
            <div className="blog-card__image-container">
              <img src={blogImg2} alt="Blog 2" className="blog-card__image" />
            </div>
            <div className="blog-card__body">
        ...
        <div className="blogs__featured">
          <div className="blog-card blog-card--col">
             <div className="blog-card__image-container blog-card__image-container--large">
               <img src={blogImg3} alt="Featured" className="blog-card__image" />
             </div>
